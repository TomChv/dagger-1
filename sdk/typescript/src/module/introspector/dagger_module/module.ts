...
import { DaggerInterface, DaggerInterfaces } from "./index.js"
...
export class DaggerModule {
   ...
   * - interfaces
   *
   * If the reference is an object, a class or an interface, recursively find the references of the object/interface.
   *
